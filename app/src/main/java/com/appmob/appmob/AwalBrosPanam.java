...
public class AwalBrosPanam extends ListActivity {
    ...
    private void tampilkan(String pilihan) {
        try {
            ...
            if (pilihan.equals("Website")) {
                ...
                a.putExtra(SearchManager.QUERY, "RS Awal Bros Panam");
            }
